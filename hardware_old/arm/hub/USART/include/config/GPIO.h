...
public:
	...
	public:
		...
		static inline void init() {
			PIN pin				  {ADDR0, PIN::OUT, PIN::PUSH_PULL, PIN::HIGH, PIN::NONE};
			pin = PIN::merge(pin, {ADDR2, PIN::OUT, PIN::PUSH_PULL,	PIN::HIGH, PIN::NONE});
			pin = PIN::merge(pin, {ADDR1, PIN::OUT, PIN::PUSH_PULL,	PIN::HIGH, PIN::NONE});
			pin = PIN::merge(pin, {ADDR3, PIN::OUT, PIN::PUSH_PULL,	PIN::HIGH, PIN::NONE});
			...
			pin = PIN::merge(pin, {DIODE, PIN::OUT, PIN::PUSH_PULL,	PIN::MEDIUM, PIN::NONE});
			pin = PIN::merge(pin, {MOSI, PIN::AF, PIN::PUSH_PULL, PIN::HIGH, PIN::PULL_UP});
			pin = PIN::merge(pin, {RX, PIN::AF, PIN::PUSH_PULL,	PIN::HIGH, PIN::NONE});
			pin = PIN::merge(pin, {TX, PIN::AF, PIN::PUSH_PULL, PIN::HIGH, PIN::NONE});
			pin = PIN::merge(pin, {NOTIFIER, PIN::IN, PIN::PUSH_PULL, PIN::HIGH, PIN::PULL_DOWN});
			setup(GPIOA, pin);
			AF af				{RX,	AF::USART_1};
			af = AF::merge(af, 	{TX, 	AF::USART_1});
			af = AF::merge(af, 	{SS, 	AF::SPI_1});
			af = AF::merge(af, 	{SCK, 	AF::SPI_1});
			af = AF::merge(af, 	{MOSI, 	AF::SPI_1});
			setup(GPIOA, af);
		}
