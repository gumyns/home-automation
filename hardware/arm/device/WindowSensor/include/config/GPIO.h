...
public:
	...
	public:
		...
		static inline void init() {
			PIN pin				  {SENSOR0, PIN::IN, PIN::PUSH_PULL, PIN::MEDIUM, PIN::PULL_UP};
			pin = PIN::merge(pin, {DIODE, PIN::OUT, PIN::PUSH_PULL,	PIN::HIGH, PIN::NONE});
