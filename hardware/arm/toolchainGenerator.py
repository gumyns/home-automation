...
set(COMMON_FLAGS " -Wall -Wextra -mcpu=cortex-m0 -mthumb -mthumb-interwork -mfloat-abi=soft -ffunction-sections -fdata-sections -g -fno-common -fmessage-length=0  --specs=nano.specs -Os -fmessage-length=0 -fsigned-char -ffreestanding")
set(CMAKE_CXX_FLAGS_INIT "${{COMMON_FLAGS}} -std=c++14")
set(CMAKE_C_FLAGS_INIT "${{COMMON_FLAGS}} -std=gnu99")
set(CMAKE_ASM_FLAGS_INIT -nostdinc)
set(CMAKE_EXE_LINKER_FLAGS_INIT
        -Wl,-gc-sections,-M=binary.map -T mem.ld -T libs.ld -T sections.ld -Xlinker -L"${{PROJECT_SOURCE_DIR}}/ldscripts",-Map,"${{PROJECT_NAME}}.map",-o"${{PROJECT_NAME}}.elf")
...
set(CMAKE_ASM_FLAGS "${{COMMON_FLAGS}} -mthumb -mcpu=cortex-m0 -x assembler-with-cpp " CACHE INTERNAL "asm compiler flags")
"""
